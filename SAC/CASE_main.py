...
def main(args, memory, agent_id):
    ...
    # Agent
    agent = CASE_SAC(env.observation_space.shape[0], env.action_space, args, agent_id)
...
parser.add_argument('--policy', default="CASE_SAC", help='Algorithm (default: CASE_SAC)')
...
if args.env == "LunarLanderContinuous-v2" or args.env == "BipedalWalker-v3":
    args.hard_update = False
