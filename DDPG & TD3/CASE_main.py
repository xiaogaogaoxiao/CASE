...
def main(args, replay_buffer, agent_id):
    ...
    # Initialize policy
    if args.policy == "CASE_DDPG":
        agent = CASE_DDPG.CASE_DDPG(**kwargs)
    elif args.policy == "CASE_TD3":
        agent = CASE_TD3.CASE_TD3(**kwargs)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--policy", default="CASE_DDPG", help='Algorithm (default: CASE_DDPG)')
    parser.add_argument("--kl_div_var", default=0.15, type=float, help='Diagonal entries of the reference Gaussian for '
